...
* **quick-4:** implement LoadDefinitionProvider for go-to-definition ([8de5642](https://github.com/Wompipomp/function-starlark-vscode/commit/8de56425e1b903db879830e57c8251562ef61b5a))
* **quick-4:** register LoadDefinitionProvider in extension activation ([2fa64db](https://github.com/Wompipomp/function-starlark-vscode/commit/2fa64db9d4eeaf55b8b5bc460c83d8474eb8962c))
* **quick-5:** classify OCI download failures with typed errors ([a08e429](https://github.com/Wompipomp/function-starlark-vscode/commit/a08e4297f1fa288f23d398d2884fa32b8f62cf75))
* **quick-5:** diagnostics provider for failed schema downloads ([9e4457f](https://github.com/Wompipomp/function-starlark-vscode/commit/9e4457f83b5430d60d682730d8d828a13b8a9a50))
* **quick-5:** surface schema download failures via toast + diagnostic ([903cc8d](https://github.com/Wompipomp/function-starlark-vscode/commit/903cc8d5cdb976ed740920ae1964bb3e7e482b49))
...
* **quick-4:** handle star imports in load() go-to-def ([0f0c8a8](https://github.com/Wompipomp/function-starlark-vscode/commit/0f0c8a8b91514956ea6f8875cd320a12373ac256))
* **quick-4:** resolve load() go-to-def per-version to avoid cache collisions ([5cb25cf](https://github.com/Wompipomp/function-starlark-vscode/commit/5cb25cfdc2b4bc153673804322d16130880c2e79))
* **quick-4:** resolve top-level assignments in load() go-to-def ([1386568](https://github.com/Wompipomp/function-starlark-vscode/commit/138656861d81c950c6c2743c6f5aa0249a2f8ae5))
